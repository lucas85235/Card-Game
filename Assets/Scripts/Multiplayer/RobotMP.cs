...
public class RobotMP : MonoBehaviour
{
    ...
    public RobotData m_Data;
    public Transform selectedCardsConteriner;

    private Dictionary<Stats, int> dataStats = new Dictionary<Stats, int>();
    private Dictionary<Stats, int> currentRobotStats = new Dictionary<Stats, int>();
